            ...
            <section className='productShow'>
                <section className='eachProductShow'>
                    ...
                    <section className='productShowDetails'>
                        ...
                        <h6><span className='price mx-1'>Tk.{products.price}</span></h6>
                        ...
                        {products.quantity <= 0 &&
                            <button className='btn disabled btnSection my-3 mx-2 mt-4' onClick={handleProceedToShipping}> Stock Out</button>
                        }
